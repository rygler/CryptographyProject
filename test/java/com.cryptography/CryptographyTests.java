...
//        assertThat(new QuadraticSieve().getPrimeFactorization(78))
//        System.out.println(new QuadraticSieve().getPrimeFactorization(new BigInteger("4581")).toString());
...
//        }
//        System.out.println(new QuadraticSieve().findBSmoothNumbers(numbers, 43));
...
//        }
//
//        System.out.println(new QuadraticSieve().findGcdOfSquareAndN(bSmoothBigIntegers, originBigIntegers, new BigInteger("90283")));
